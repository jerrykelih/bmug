...
?>
	<h1 class="event_title ui-widget-header ui-corner-top" id="event_title-<?php echo $event_id; ?>">
...
?>
	...
	?>			
				...
				<h3 class="date-heading">Date and Time</h3>
	...
	?>
				...
				<p class="ical-link">
						Download <?php echo apply_filters('filter_hook_espresso_display_ical', $all_meta); ?>
				</p>

				<!-- SPEAKER -->

				<h3 class="speaker-heading">Speaker</h3>
